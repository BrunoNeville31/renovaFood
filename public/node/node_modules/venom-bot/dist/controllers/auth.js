...
exports.auth_InjectToken = exports.retrieveQR = exports.isInsideChat = exports.needsToScan = exports.isAuthenticated = void 0;
/*
...
function auth_InjectToken(page, session) {
    return __awaiter(this, void 0, void 0, function () {
        var pathToken, jsonToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    pathToken = path.join(path.resolve(process.cwd(), 'tokens'), session + ".data.json");
                    if (!fs_1.existsSync(pathToken)) return [3 /*break*/, 2];
                    jsonToken = JSON.parse(fs_1.readFileSync(pathToken).toString());
                    if (!jsonToken)
                        return [2 /*return*/];
                    return [4 /*yield*/, page.evaluateOnNewDocument(function (session) {
                            localStorage.clear();
                            Object.keys(session).forEach(function (key) {
                                return localStorage.setItem(key, session[key]);
                            });
                        }, jsonToken)];
                case 1: 
                //if (jsonToken)
