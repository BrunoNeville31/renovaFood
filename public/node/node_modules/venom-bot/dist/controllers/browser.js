        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    waPage = _a.sent();
                    // Auth with token
                    return [4 /*yield*/, auth_1.auth_InjectToken(waPage, session)];
                case 3:
                    // Auth with token
                    _a.sent();
                    return [4 /*yield*/, waPage.setUserAgent('WhatsApp/2.2019.8 Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36')];
                case 4:
                    _a.sent();
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, puppeteer_extra_1.default.launch(__assign({ 
                            // headless: true,
                            headless: options.headless, devtools: options.devtools, 
